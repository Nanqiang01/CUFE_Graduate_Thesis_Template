...
\usepackage{amsmath, amsthm, amsfonts} % 数学环境
...
%  页边距设置
%---------------------------------------------------------------------
\geometry{left=2.5cm, right=2.5cm, top=2.54cm, bottom=2.54cm, xetex}
%---------------------------------------------------------------------
%  脚注设置
%---------------------------------------------------------------------
...
% 图表上下行间距设置
%---------------------------------------------------------------------
\captionsetup[table]{position=above, aboveskip=2bp, belowskip=17bp}
\captionsetup[figure]{position=below, aboveskip=5bp, belowskip=17bp}
%---------------------------------------------------------------------
% 图表顺序标号，不分章节
%---------------------------------------------------------------------
...
\setCJKfamilyfont{zhsong}[AutoFakeBold=2.17, AutoFakeSlant]{SimSun}
\setCJKfamilyfont{zhhei}[AutoFakeBold=2.17, AutoFakeSlant]{SimHei}
